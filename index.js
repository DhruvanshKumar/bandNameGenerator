...
app.post("/submit", (req, res) => {
  var lenAdj = adj.length;
  var lenNoun = noun.length;
  var random = adj[Math.floor(Math.random()*(lenAdj-1))] + " " + noun[Math.floor(Math.random()*(lenNoun-1))];
  res.render("index.ejs", {randomName : random});
